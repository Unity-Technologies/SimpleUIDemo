...
static const size_t Baselib_RegisteredNetwork_Endpoint_MaxSize = 28; // in bytes
...
// \param allowEndpointReuse    Allow multiple sockets to be bound to the same address/port.
//                              All sockets bound to the same address/port need to have this flag set to true.
