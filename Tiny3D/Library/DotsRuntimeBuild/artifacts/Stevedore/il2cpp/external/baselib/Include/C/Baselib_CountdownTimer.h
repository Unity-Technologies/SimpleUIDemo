...
static inline Baselib_Timer_Ticks Detail_MillisecondsToTicks(double milliseconds)
{
...
static inline double Detail_TicksToMilliseconds(Baselib_Timer_Ticks ticks)
{
...
static inline Baselib_CountdownTimer Baselib_CountdownTimer_StartMs(uint32_t timeoutInMilliseconds)
{
...
static inline Baselib_CountdownTimer Baselib_CountdownTimer_StartTicks(Baselib_Timer_Ticks timeoutInTicks)
{
...
static inline Baselib_Timer_Ticks Baselib_CountdownTimer_GetTimeLeftInTicks(Baselib_CountdownTimer timer)
{
...
// This function is guaranteed to return zero once timeout expired.
// It is also guaranteed that this function will not return zero until timeout expires.
static inline uint32_t Baselib_CountdownTimer_GetTimeLeftInMilliseconds(Baselib_CountdownTimer timer)
{
...
static inline bool Baselib_CountdownTimer_TimeoutExpired(Baselib_CountdownTimer timer)
{
