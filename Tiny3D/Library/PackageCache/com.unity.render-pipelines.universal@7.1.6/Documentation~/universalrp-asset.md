...
| __Terrain Holes__       | If you disable this option, the Universal RP removes all Terrain hole Shader variants when you build for the Unity Player, which decreases build time. |
