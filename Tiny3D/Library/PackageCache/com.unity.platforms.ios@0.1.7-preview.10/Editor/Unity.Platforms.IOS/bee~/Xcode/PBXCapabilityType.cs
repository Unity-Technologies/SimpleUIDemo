...
#endif
{
    ...
    public sealed class PBXCapabilityType
    {
        ...
        public static readonly PBXCapabilityType GameCenter = new PBXCapabilityType("com.apple.GameCenter.iOS", false, "GameKit.framework");
        ...
        public static readonly PBXCapabilityType AccessWiFiInformation = new PBXCapabilityType("com.apple.developer.networking.wifi-info", true);
        ...
        public static PBXCapabilityType StringToPBXCapabilityType(string cap)
        {
            switch (cap)
            {
                ...
                case "com.apple.networking.wifi-info":
