...
#endif
{
    ...
    internal class PBXShellScriptBuildPhaseData : FileGUIDListBase
    {
        ...
        public override void UpdateProps()
        {
            ...
            SetPropertyList("inputPaths", inputPaths);
        }
        ...
        public override void UpdateVars()
        {
            ...
            inputPaths = GetPropertyList("inputPaths");
        }
    }
    ...
    internal class XCBuildConfigurationData : PBXObjectData
    {
        ...
        public string GetProperty(string name)
        {
            if (entries.ContainsKey(name))
                return string.Join(" ", entries[name].val.ToArray());
